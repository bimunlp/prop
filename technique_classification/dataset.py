...
def get_train_file(articles, ref_articles_id, ref_span_starts, ref_span_ends, labels, train_file):
    train = dataset_to_pandas(articles, ref_articles_id, ref_span_starts, ref_span_ends, labels)
    save_dataset(train, train_file)

def get_dev_file(articles, ref_articles_id, ref_span_starts, ref_span_ends, labels, dev_file):
    dev = dataset_to_pandas(articles, ref_articles_id, ref_span_starts, ref_span_ends, labels)
